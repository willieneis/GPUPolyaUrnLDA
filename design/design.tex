...
\begin{itemize}
\item $\v{w}$: unsigned int array (4 byte per topic)
\item $\v{z}$: unsigned short array (2 byte per topic)
\item $\v{d}$: unsigned short array document length (2 byte per topic)
\end{itemize}
